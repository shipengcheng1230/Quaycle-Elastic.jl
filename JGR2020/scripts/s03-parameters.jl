...
begin # for smaller VW
    set_mid_03("pf-s-w2.h5",    2e3,  nothing, 1.0,           single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-w3.h5",    3e3,  nothing, 1.0,           single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-w5.h5",    5e3,  nothing, 1.0,           single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-w10.h5",   10e3, nothing, 1.0,           single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-w15.h5",   15e3, nothing, 1.0,           single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-w10.h5",   10e3, nothing, 1.0,           single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-w20.h5",   20e3, nothing, 1.0,           single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-w30.h5",   30e3, nothing, 1.0,           single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-w40.h5",   40e3, nothing, 1.0,           single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-s60.h5",   10e3, "σc", 60e6,             single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-s25.h5",   10e3, "σ",  25e6,             single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s-a0.5.h5",  10e3, "a", 0.0115+0.0035*0.5, single=true, abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)

    set_mid_03("pf-00.h5",      10e3, nothing, 1.0,                  abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)

    set_mid_03("pf-s10000.h5",  10e3, "σc", 10000e6,                 abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s5000.h5",   10e3, "σc", 5000e6,                  abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s1000.h5",   10e3, "σc", 1000e6,                  abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-s500.h5",    10e3, "σc", 500e6,                   abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    ...
    set_mid_03("pf-b10000.0.h5",10e3, "b", 0.015 - 0.0035 * 1e4,     abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-b1000.0.h5", 10e3, "b", 0.015 - 0.0035 * 1e3,     abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-b100.0.h5",  10e3, "b", 0.015 - 0.0035 * 1e2,     abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-b10.0.h5",   10e3, "b", 0.015 - 0.0035 * 10.0,    abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    ...
    set_mid_03("pf-b0.05.h5",   10e3, "b", 0.015 - 0.0035 * 0.05,    abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)

    set_mid_03("pf-a10000.0.h5",10e3, "a", 0.0115 + 0.0035 * 1e4,    abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-a1000.0.h5", 10e3, "a", 0.0115 + 0.0035 * 1e3,    abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-a100.0.h5",  10e3, "a", 0.0115 + 0.0035 * 1e2,    abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-a10.0.h5",   10e3, "a", 0.0115 + 0.0035 * 10.0,   abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    ...
    set_mid_03("pf-a0.05.h5",   10e3, "a", 0.0115 + 0.0035 * 0.05,   abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    ...
    set_mid_03("pf-l100.0.h5",  10e3, "L", 0.1,                      abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-l1000.0.h5", 10e3, "L", 1.0,                      abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
    set_mid_03("pf-l10000.0.h5",10e3, "L", 10.0,                     abvw=0.0035, Dc=4e-3, avw=0.015, vwdepth=5e3)
end